...
<div class="justify-content-center">
    <h1>Módulo para Personal</h1>
    <hr>
    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
        <a type="button" href="{{ route('personal.create') }}" class="btn btn-success">Agregar Personal</a>
    </div>
    <hr>
        ...
        <thead>
          ...
          <tbody>
           @foreach ($personal as $item)
            <tr>
                <td style="width:15%;">
                    <a class="btn btn-primary" href="{{ route('personal.edit',$item->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar"><i class="fa fa-file"></i></a>
