...
<div class="justify-content-center">
    <h1>Módulo para Carreras</h1>
    <hr>
    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
        <a type="button" href="{{ route('carrera.create') }}" class="btn btn-success">Agregar Carrera</a>
    </div>
    <hr>
        ...
        <thead>
          ...
          <tbody>
           @foreach ($carrera as $item)
            <tr>
                <td style="width:15%;">
                    <a class="btn btn-primary" href="{{ route('carrera.edit',$item->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar"><i class="fa fa-file"></i></a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{ route('carrera.destroy',$item->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
