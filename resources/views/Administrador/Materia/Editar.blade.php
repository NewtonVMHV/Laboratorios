        ...
        <form action="{{ route('materia.update',$materia) }}" method="post">
            ...
            <div class="row mb-4">
                <div class="col form-outline">
                    ...
                    <input type="text" name="claveMat" class="form-control" placeholder="xxxxxxxxx" value="{{ $materia->ClaveMat }}" required/>
                </div>
                <div class="col form-outline">
                    ...
                    <select name="nivel_escolar" class="form-select" aria-label="Default select example" required>
                        <option selected>{{ $materia->Nivel_Escolar }}</option>
            ...
            <div class="row mb-4">
                <div class="col form-outline">
                    ...
                    <input type="text" name="nombre" class="form-control" placeholder="xxxxxxxxx" value="{{ $materia->Nombre }}" required/>
                </div>
                <div class="col form-outline">
            ...
            <div class="row mb-4">
                <div class="col form-outline">
                    ...
                    <input type="text" name="nombreAbreviado" class="form-control" placeholder="xxxxxxxxx" value="{{ $materia->NombreAbreviado }}" required/>
                </div>
                <div class="col form-outline">
            ...
            <div class="row mb-4">
                <div class="col form-outline">
                    ...
                    <select name="departamento" class="form-select" aria-label="Default select example" required>
                        <option selected>{{ $materia->Departamento }}</option>
