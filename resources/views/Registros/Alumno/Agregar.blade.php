...
@section('content')
    <div class="justify-content-center">
        <h1>Agregar Nuevo Registro <a href="{{route('registro_alumno')}}"><span class="badge bg-secondary">Regresar</span></a></h1>
        @if ($errors->any())
    ...
    <form action="{{ route('registro_alumo.store') }}" method="post">
        @csrf
        @method('post')
        <div class="row mb-4">
            <div class="col">
        ...
        <div class="row mb-4">
            <div class="col">
                <div class="form-outline">
                    ...
                    <input class="form-control" list="datalistOptions" id="exampleDataList" name="materia" placeholder="Type to search...">
