...
<div class="justify-content-center">
    <h1>Módulo para Registro de Alumnos</h1>
    <hr>
        ...
        <thead>
          ...
          <tbody>
           @foreach ($registro_alumno as $item)
            <tr>
                <td style="width:15%;">
                    <a class="btn btn-primary" href="{{ route('registro_alumno.edit',$item->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar"><i class="fa fa-file"></i></a>
                    ...
                    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                    <form action="{{ route('registro_alumno.destroy',$item->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger">Eliminar</button>
                                    </form>
