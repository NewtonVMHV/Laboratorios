...
<div class="justify-content-center">
    <h1>Módulo para Registro de Docentes</h1>
    <hr>
    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
        <a type="button" href="{{ route('registro_docente.create') }}" class="btn btn-success">Agregar Registro</a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ route('registro_docente.eliminarTabla') }}" method="post">
                            @csrf
                            @method('DELETE')
        ...
        <a type="button" href="{{ route('registro_docente.export') }}" class="btn btn-warning">Exportar</a>
    </div>
    <hr>
    ...
    <table id="tabla" class="table table-hover">
        <thead>
          ...
          <tbody>
           @foreach ($registro_docente as $item)
            <tr>
                <td style="width:15%;">
                    <a class="btn btn-primary" href="{{ route('registro_docente.edit',$item->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar"><i class="fa fa-file"></i></a>
                    ...
                    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                    <form action="{{ route('registro_docente.destroy',$item->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger">Eliminar</button>
                                    </form>
